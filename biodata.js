...
// number of passport getting 

var pnumb = $("#pnumget").val();
var piss = $("#pissueget").val();
var pexpi = $("#pexpget").val();
...
$("#pn").html("Passport Number" + "&nbsp&nbsp&nbsp&nbsp" + ":" + "&nbsp" +pnumb);
//issue get
$("#pi").html("Passport Issue" + "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp" + ":" + "&nbsp" +piss);
//expirty getting
$("#pe").html("Passport Expiry" + "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp" + ":" + "&nbsp" +pexpi);
